       ...
       <template v-slot:activator="{ props }">
           <v-list-item v-bind="props">
               <v-list-item-title class="d-flex align-center">
                   <v-icon size="18" class="mr-1" color="#888">mdi-reload</v-icon>
                   <span class="menu-text">Reset exam</span>
               </v-list-item-title>
           </v-list-item>
       </template>
         ...
         <div class="dialog">
           ...
           >
               <div class="pl-3 pr-3 d-flex flex-row align-center justify-space-between w-100">
                   <span class="text-h5" style="color: #fff">Reset exam for {{ getUserName() }}</span>
                   <v-btn
                   density="compact"
                   icon
                   @click="dialog=false"
           ...
           <div class="dialog__content">
               ...
               <div class="w-100 d-flex justify-center">
                   ...
                   :disabled="blockBtn"
                   >
                   <span :style="blockBtn ? 'color: #777' : 'color:#fff'" v-if="!loader">Reset exam</span>
                   <v-progress-circular
                   :width="1"
                   size="15"
           ...
           <div class="alerts">           
               ...
               >
                   ...
                   <span style="color:#fff">Exam reseed successfully</span>
               </v-alert>
           </div>
         </div>
       </template>
