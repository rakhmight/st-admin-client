<template>
    <v-container style="margin-top: 54px" v-if="getAuthState">
        ...
        >
            ...
            <!-- For inspector & admin -->
            <v-tab value="incoming" style="border-bottom: 1px solid #ccc" v-if="getRole!='author'"><span class="text-subtitle-2">Incoming</span></v-tab>
            <!-- For author -->
            <v-tab value="send" style="border-bottom: 1px solid #ccc" v-if="getRole=='author'"><span class="text-subtitle-2">Send for check</span></v-tab>
            <!-- General -->
            <v-tab value="review" style="border-bottom: 1px solid #ccc" v-if="getRole!='admin'"><span class="text-subtitle-2">Under review</span></v-tab>
        ...
        <v-window v-model="tab" class="mt-5">
            ...
            <v-window-item value="incoming" v-if="getRole!='author'">
                <box-incoming v-if="!reRenderSwitcher" />
            </v-window-item>
            <v-window-item value="send" v-if="getRole=='author'">
                <box-send :switchReRender="switchReRender" />
            </v-window-item>
            <v-window-item value="review" v-if="getRole!='admin'">
